...
export function MiniTestsCategoryModal({ vm }: MiniTestsCategoryModalProps) {
  return (
    ...
    >
      <DialogContent className="flex max-h-[94vh] max-w-6xl flex-col overflow-hidden rounded-[24px] border border-[#eaecf2] p-5 text-base sm:p-7">
                            ...
                            <div className="flex items-start justify-between gap-2">
                              <div>
                                ...
                                <p className="text-[13px] font-medium text-[#8b90a3]">
                                  연결 과제{" "}
                                  {vm.assignmentCountByCategory[category.id] ??
                                    0}
                                  개
                                </p>
                              </div>
                ...
                <div className="grid gap-3 rounded-[14px] border border-[#eaecf2] bg-[#fcfcfd] p-3 sm:grid-cols-2">
                  <div className="space-y-1.5">
                    ...
                    <Select
                      ...
                      disabled={
                        vm.isBusy || vm.filteredClassOptions.length === 0
                      }
                    >
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Select
                      ...
                      disabled={
                        vm.isBusy ||
                        vm.filteredExamsInSelectedClass.length === 0
                      }
                    >
                      <SelectTrigger className="h-10 rounded-[10px] border-[#e9ebf0] bg-white text-[14px] font-medium">
              ...
              >
                ...
                {vm.isModalTargetMismatch ? (
                  <p className="mt-2 text-[13px] font-medium text-amber-700">
                    주의: 현재 페이지 선택 시험(
                    {vm.selectedExamMeta?.examName ?? "미선택"})과 모달 적용
                    시험(
